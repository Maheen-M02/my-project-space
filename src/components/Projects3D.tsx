...
const projects = [
  {
    ...
    description: 'Real-time analytics dashboard with 3D data visualization and interactive charts powered by Three.js.',
  ...
  },
  {
    ...
    description: 'E-commerce platform with liquid animations, smooth transitions, and immersive product experiences.',
    tags: ['Next.js', 'GSAP', 'Stripe', 'Prisma'],
  ...
  {
    title: 'Neural Canvas',
    description: 'AI-powered generative art platform where users create unique visuals through text prompts.',
    tags: ['Python', 'TensorFlow', 'WebGL', 'FastAPI'],
  ...
  {
    title: 'Quantum Notes',
    description: 'Collaborative note-taking app with real-time sync, markdown support, and spatial organization.',
    tags: ['React', 'Firebase', 'Yjs', 'Tailwind'],
